...
const LiveSection: FC<Props> = (props) => {
  ...
  return (
    <section className={styles.container}>
      <div>
        <strong className={styles.current_temperature}>{live.T1H?.obsrValue}℃</strong>
        <strong className={styles.current_sky}>{getRainyType(live.PTY?.obsrValue)}</strong>
      </div>
      <div>
        ...
        <span className={styles.today_temperature_description}>(오전 6시, 오후 3시)</span>
      </div>
